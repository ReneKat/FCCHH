...
then
  ...
  cp ./02_Assembly/metaspades/${project}_merged/scaffolds.fa ./02_Assembly/quast/${project}/metaspades_merged.fasta
  echo Using megahit to assemble ${HQ_Reads} ${project} reads.
#    megahit -r ./01_HQ_Reads/merged_reads/${project}_HQ_merged.fq.gz --12 ./01_HQ_Reads/merged_reads/${project}_HQ_unmerged.fq.gz --presets meta-large -m ${RAM} -t ${CPU} -o ./02_Assembly/megahit-large/${project} >> ./02_Assembly/megahit-large/logs/${project}.log 2>&1
